          ...
          <div class="product-data">
            ...
            <div class="row product-buttons">
                <div class='col-12 col-md-12 col-lg-4 mt-2'>
                    <button  onclick='increaseProduct(${chosenItem.id}, ${chosenItem.price})' type='submit'>+</button>
                        <span id='count${chosenItem.id}'>${chosenItemCount.length}</span>
                    <button onclick='decreaseProduct(${chosenItem.id}, ${chosenItem.price})' type='submit'>-</button>
                </div>
...
function drawViewFavPage(favId){
  ...
  `
    <div id='favConatiner${favItem.id}' class="col-12 col-lg-6 col-md-6 col-sm-6 mb-3">

      <div class="row">

        <div class="col-3 view-page-img">
            <img class="card-img-top" src="${favItem.image}" alt="${favItem.title}" style="width:100%; height:auto">
        </div>
        ...
        <div class="col-9">
          ...
          <div class="product-data">
            ...
            <div class="row product-buttons">
                <button id='removeFav${favItem.id}' class="col-4 p-0 fav" onclick='removeFromFav(${favItem.id})' value='0'>
...
function increaseProduct(id, price){
    ...
    //insert cart into local storage
    console.log(chosenProductArrs + 'afterpush')
    localStorage.setItem('cartContent', chosenProductArrs);
...
function addToCart(id, price){
    ...
    function drawCartLayer(chosenID){
            ...
            cartLayer.innerHTML +=  
                        `<div id='productContainer${chosenItem.id}' class='row'>
